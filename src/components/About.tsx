...
function About() {
    ...
    return (
        <section className="About">
            ...
            <p className="Elevator-Pitch">Hi! I'm Alex, a detail driven web developer who loves creating fun digital expriences. My passion for design, and a background in marketing, has always pushed me to consider all of the minute details that go into crafting a positive user experience. Recently, I completed the Grand Circus Full Stack bootcamp, where I gained valuable knowledge in JavaScript, HTML, CSS, and React. This has given me a strong foundation to build upon, and I’m excited to take my problem solving, strong interpersonal and creative design skills to the next level as a team member, and web developer with your company!</p>
            <h3>Skills</h3>
        ...
        <div className="List-Container">
            ...
            <h3>LANGUAGES</h3>
            <p><i className="material-icons" id="tornado"> play_for_work </i> JavaScript (ES6)</p>
